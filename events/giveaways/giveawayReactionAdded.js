...
module.exports = {
  async execute(giveaway, reactor, messageReaction) {
    ...
    .setDescription(
      `Your entry to [This Giveaway](https://discord.com/channels/${giveaway.guildId}/${giveaway.channelId}/${giveaway.messageId}) has been approved!\n\nBy reacting to the giveaway message, you allow us to send your DMs anytime unless you remove the react.`
    )
    .setFooter({ text: "Hope you win :)" })
    .setTimestamp()
   let denied =  new Discord.EmbedBuilder()
    ...
    .setDescription(
      `Your entry to [This Giveaway](https://discord.com/channels/${giveaway.guildId}/${giveaway.channelId}/${giveaway.messageId}) has been denied, please review the requirements of the giveaway properly.`
    )
    .setFooter({ text: "You missing something.." })
